...
plot_occurrences <- ggplot(yearly_count, aes(x = yr, y = TotalTornadoes)) +
  ...
  annotate("text", x = 2011, y = 470, size = 6, label = "2011 Super Outbreak", angle = 90, vjust = -0.5) +
  annotate("text", x = 1974, y = 475, size = 6, label = "1974 Super Outbreak", angle = 90, vjust = -0.5) +
  annotate("text", x = 2020, y = 620, size = 6, label = "2020 Easter Tornado Outbreak", angle = 90, vjust = -0.5) +
...
plot_occurrences <- plot_occurrences + theme(plot.margin = margin(5, 12, 12, 5, "mm"))
plot_mag <- plot_mag + theme(plot.margin = margin(5, 5, 12, 12, "mm"))
plot_width <- plot_width + theme(plot.margin = margin(12, 12, 5, 5, "mm"))
plot_length <- plot_length + theme(plot.margin = margin(12, 5, 5, 12, "mm"))
...
# Save the combined plot as a single image
ggsave("combined_plots_3.png", combined_plot, width = 30, height = 15, dpi = 300, bg = "white")
