...
plot_occurrences <- ggplot(yearly_count, aes(x = yr, y = TotalTornadoes)) +
  ...
  annotate("text", x = 2011, y = 460, size = 6, label = "2011 Super Outbreak", angle = 90, vjust = -0.5) +
  annotate("text", x = 1974, y = 465, size = 6, label = "1974 Super Outbreak", angle = 90, vjust = -0.5) +
  annotate("text", x = 2020, y = 600, size = 6, label = "2020 Easter Tornado Outbreak", angle = 90, vjust = -0.5) +
