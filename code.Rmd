...
plot_occurrences <- plot_occurrences + theme(plot.margin = margin(0, 3, 3, 0, "mm"))
plot_mag <- plot_mag + theme(plot.margin = margin(0, 0, 3, 3, "mm"))
plot_width <- plot_width + theme(plot.margin = margin(3, 3, 0, 0, "mm"))
plot_length <- plot_length + theme(plot.margin = margin(3, 0, 0, 3, "mm"))
