...
pal <- c("#2c4875", "#8a508f", "#bc5090", "#ff6361", "#ff8531", "#ffa600", "#ffd380")
...
distribution_map <- ggplot(data = df_state) +
  ...
  geom_text(aes(x, y, label = month), df_base_labs, family = "DM Sans", size = 4, colour = "black") +
  ...
  theme(
    text = element_text(family = "DM Sans", size = 48, lineheight = 0.3, colour = "black"),
...
colors <- c("0-999" = pal_3[3], "1000-1999" = pal[9], "2000-2999" = pal[7], "3000-3999" = pal[2], "4000+" = pal[6])
